"""Structured case-study data — mirrors 03-Case-Studies/*.md in the parent repo.
...
CASE_STUDIES: list[CaseStudy] = [
    CaseStudy(
        ...
        what_we_did=[
            ...
            "Podcast production.",
            "UI/UX consultation on their app — advised on how the app's UI/UX should work "
    ...
    CaseStudy(
        ...
        what_we_did=[
            ...
            "library — a control tagged with the framework clauses it satisfies, so "
        ...
        testimonial=None,
        one_liner=(
            "Auditrail — a compliance and audit workspace that lets teams answer a "
            "control once and reuse it across every framework and audit."
        ),
        teaser=(
            "A compliance and audit workspace — one control library mapped across "
