...
BLOG_POSTS: list[BlogPost] = [
    BlogPost(
        ...
        body=[
            ...
            "around), and — the question that matters most — what \"done\" actually "
            "looks like. Half of scoping failures come from two people picturing a "
            ...
            "projects over open-ended staffing — it keeps the incentive aligned: we "
            "get paid for a defined outcome, not for hours on a clock. If the scope "
